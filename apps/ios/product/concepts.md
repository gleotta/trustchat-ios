...
| 32 | TrustChat Preset Servers | [rules.md](rules.md) (RULE-24, RULE-25), [views/onboarding.md](views/onboarding.md) | [spec/architecture.md](../spec/architecture.md) | `Shared/TrustChat/TrustChatConfig.swift`, `Shared/TrustChat/TrustChatConfig.plist`, `Shared/Model/SimpleXAPI.swift` (`startChat`, `getUserServersSync`, `setUserServersSync`, `validateServersSync`), `Shared/AppDelegate.swift`, `Shared/Views/Onboarding/CreateProfile.swift`; test `Tests iOS/Tests_iOS.swift` (`testTrustChatServersPolicy`) | `Library/Commands.hs` (`APISetUserServers`, `APIValidateServers`), `Operators.hs` (`validateUserServers`) |
